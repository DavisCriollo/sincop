...
class DetallePedidoGuardia extends StatefulWidget {
  ...
  const DetallePedidoGuardia({Key? key, this.codigoPedido}) : super(key: key);
...
// print('ID: ${widget.codigoPedido}');
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future: pedidoController.getTodosLosPedidosGuardias(''),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        //*****************************************/
                        _listaPedidos.isNotEmpty? Container(
                            margin: EdgeInsets.only(
                                top: size.iScreen(0.1),
                                bottom: size.iScreen(0.0)),
                            width: size.wScreen(100.0),
