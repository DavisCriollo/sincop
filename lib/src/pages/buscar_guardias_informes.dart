...
//                         if (provider.getErrorInfoGuardiaInforme == null) {
//                           return const NoData(
//                             label: 'Ingrese dato para búsqueda',
//                           );
//                         } else if (provider.getErrorInfoGuardiaInforme ==
//                             false) {
//                            return const NoData(
//                             label: 'No existen datos para mostar',
//                           );
//                         } else if (provider
//                             .getListaInfoGuardiaInforme.isEmpty) {
//                           return const NoData(
//                             label: 'No existen datos para mostar',
//                           );
//                           // Text("sin datos");
...
//                           itemCount: provider.getListaInfoGuardiaInforme.length,
//                           itemBuilder: (BuildContext context, int index) {
//                             final guardia =
//                                 provider.getListaInfoGuardiaInforme[index];
//                             return Card(
//                               child: ListTile(
