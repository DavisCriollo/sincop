...
class _ListaMultasSupervisorState extends State<ListaMultasSupervisor> {
  ...
  void initData() async {
    ...
    loadInfo.getTodasLasMultasGuardia('');
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Slidable(
                        startActionPane: ActionPane(
                          ...
                          children: [
                            //  SlidableAction can have an icon and/or a label.
                            multas.nomEstado == 'ACTIVA' &&
                                    widget.user!.usuario == multas.nomDocuPer
                                ? SlidableAction(
                                    onPressed: (context) {
                                      multasControler
                            ...
                            //   // label: 'Editar',
                            //   onPressed: (context) {
                            //      multasControler.getTodosLosClientesMultas('');
                            //       Navigator.push(
                            //     context,
                            //     MaterialPageRoute(
                            //         builder: ((context) =>
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        // CupertinoSwitch(
                                        //   activeColor: const Color(0XFF3DA9F4),
                                        //   value: (multas.nomEstado == 'ACTIVA')
                                        //       ? true
                                        //       : false,
                                        //   onChanged: (value) {
                                        //     _modalEstadoMulta(
