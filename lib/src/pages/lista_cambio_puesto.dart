...
class ListaCambioPuestoPage extends StatefulWidget {
  const ListaCambioPuestoPage({Key? key}) : super(key: key);

  @override
  State<ListaCambioPuestoPage> createState() =>
      _ListaCambioPuestoPageState();
}
...
class _ListaCambioPuestoPageState extends State<ListaCambioPuestoPage> {
  ...
  void initData() async {
    final loadInfo = Provider.of<CambioDePuestoController>(context, listen: false);
    loadInfo.buscaCambioPuesto('');
        ...
        child: Scaffold(
            ...
            RefreshIndicator(
              ...
              child: SizedBox(
                  ...
                  child:
                      Consumer<CambioDePuestoController>(builder: (_, provider, __) {
                            ...
                            children: [
                              ...
                              SlidableAction(
                                onPressed: (context) async {
                                  ...
                                  await provider.eliminaCambioPuesto(
                                        puesto['camId']);
